...
\begin{frame}{Creighton \textit{et al.} metagene correlates with BMI}
	\hspace{-4.0ex}
	\includegraphics[width=0.45\paperwidth]{./images/png/crmetaclin0}
	\includegraphics[width=0.45\paperwidth]{./images/png/crmetaclin1}
\end{frame}
...
\begin{frame}{Metagene in ICGC data}
	\begin{adjustwidth}{-1.5em}{-1.5em}
		...
		\includegraphics[width=0.23\paperwidth]{./images/png/crtcga16}
		\includegraphics[width=0.23\paperwidth]{./images/png/crtcga19}
		\includegraphics[width=0.23\paperwidth]{./images/png/crtcga22}
	\end{adjustwidth}
\end{frame}
...
\begin{frame}{Does the metagene correlate with BMI?}
	\begin{adjustwidth}{-1.5em}{-1.5em}
		...
		\includegraphics[width=0.23\paperwidth]{./images/png/crtcga17}
		\includegraphics[width=0.23\paperwidth]{./images/png/crtcga20}
		\includegraphics[width=0.23\paperwidth]{./images/png/crtcga23}
	\end{adjustwidth}
\end{frame}
...
\begin{frame}{FM metagene in other cancer types}
	\begin{adjustwidth}{-1.5em}{-1.5em}
		...
		\includegraphics[width=0.23\paperwidth]{./images/png/fmtcga16}
		\includegraphics[width=0.23\paperwidth]{./images/png/fmtcga19}
		\includegraphics[width=0.23\paperwidth]{./images/png/fmtcga22}
	\end{adjustwidth}
\end{frame}
...
\begin{frame}{FM metagene and BMI}
	\begin{adjustwidth}{-1.5em}{-1.5em}
		...
		\includegraphics[width=0.23\paperwidth]{./images/png/fmtcga17}
		\includegraphics[width=0.23\paperwidth]{./images/png/fmtcga20}
		\includegraphics[width=0.23\paperwidth]{./images/png/fmtcga23}
	\end{adjustwidth}
\end{frame}
