...
\begin{frame}{Progress Overview}
	...
	{\footnotesize
		\begin{itemize}
			\item Gene expression analysis in Creighton \textit{et al.} data
			\item Gene expression analysis in ICGC data
			\item Pathway enrichment analysis in ICGC data
...
\begin{frame}{Results}
	\begin{center}
		\includegraphics[width=0.90\paperwidth]{./images/allmeta1}
	\end{center}
\end{frame}

\begin{frame}{Results}
	\begin{center}
		\includegraphics[width=0.90\paperwidth]{./images/allmeta2}
	\end{center}
\end{frame}

\begin{frame}{Results}
	\begin{center}
		\includegraphics[width=0.45\paperwidth]{./images/allmetacor1}
	\end{center}
\end{frame}
